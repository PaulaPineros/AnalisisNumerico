...
server <- function(input, output, session) {
    ...
    CalcularSI <- function(){
        ...
        output$distPlot <- renderPlot({         #Imprime la gráfica dada por la solución del método Runge Kutta 4
            ...
            plot(times, S, type="l", col="blue", ylim=c(0,sum(iniciales)), xlab="Tiempo (en días)", ylab="Numero de host",main = "Metodo 1: Runge Kutta 4")
        ...
        output$distPlot2 <- renderPlot({        #Imprime la gráfica dada por la solución del método de Euler
            ...
            plot(times, S, type="l", col="blue", ylim=c(0,sum(iniciales)), xlab="Tiempo (en días)", ylab="Numero de host", main = "Metodo 2: Euler")
            lines(times, I, type="l", col="red")
            legend(x = "topright", legend=c("Susceptibles", "Infectados"), col=c("blue", "red"), lty=rep(1, 2)) 
    ...
    mostrarReales <- function(){
        ...
        output$distPlot <- renderPlot({
            ...
            plot(times, S, type="l", col="blue", xlab="Tiempo (en días)", ylab="Numero de host",main = "Datos Reales", ylim=c(0,n))
            lines(times, I, type="l", col="red")
            lines(times, R, type="l", col="green")
